...
StoppedTasksCard.propTypes = {
  ...
  func: PropTypes.func,
  error: PropTypes.shape({
    total: { value: PropTypes.number, func: PropTypes.func },
    last: { value: PropTypes.number, func: PropTypes.func },
  }),
  warning: PropTypes.shape({
    total: { value: PropTypes.number, func: PropTypes.func },
    last: { value: PropTypes.number, func: PropTypes.func },
